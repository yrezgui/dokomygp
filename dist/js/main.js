...
var DoctorItem = React.createClass({displayName: 'DoctorItem',
  callDoctor: function () {
  ...
  render: function() {
    return (
      React.createElement("li", {onClick: this.callDoctor}, 
        React.createElement("p", {className: "doctor-name"}, this.props.doctor.name.toLowerCase()), 
        React.createElement("p", {className: "doctor-address"}, this.props.doctor.address.replace('\n', ' \u0387 '))
      )
    );
  }
});
...
var DoctorsList = React.createClass({displayName: 'DoctorsList',
  render: function() {

    var itemNodes = this.props.data.map(function (doctor) {
      var doctorId = doctor['id/_source'];

      return React.createElement(DoctorItem, {key: doctorId, doctor: doctor})
    });

    return React.createElement("ul", null, itemNodes)
  }
});

module.exports = DoctorsList;
},{"./doctor-item":149,"react":148}],151:[function(require,module,exports){
var React = require('react');
...
var Home = React.createClass({displayName: 'Home',
  ...
  render: function() {
    return (
      React.createElement("section", {role: "region", 'data-position': "current", className: this.defaultClassName + ' ' + this.state.animation}, 
        React.createElement("article", {className: "content scrollable"}, 
          React.createElement("form", {className: "vertical-center", onSubmit: this.handleSubmit}, 
            React.createElement("div", {className: "text-center main-logo"}, 
              React.createElement("img", {src: "../../../logo.png"}), 
              React.createElement("br", null), 
              React.createElement("h1", null, "Doko My GP")
            ), 
            React.createElement("p", {className: "text-center"}, 
              React.createElement("button", null, "Get my position")
            )
          )
        )
      )
  ...
  render: function() {
    ...
    return (
      React.createElement("section", {role: "region"}, 
        React.createElement("header", {className: "fixed"}, 
          React.createElement("menu", {type: "toolbar"}, 
            React.createElement("button", {className: "refresh-data", 'data-icon': "reload", onClick: this.refreshData})
          ), 
          React.createElement("h1", null, "Doko My GP")
        ), 
        React.createElement("article", {className: "content scrollable header"}, 
          React.createElement(StatusMessage, {status: this.state.status}), 
          React.createElement("div", {'data-type': "list"}, 
            React.createElement(DoctorsList, {data: this.state.data})
          )
        )
      )
    );
...
},{"../constants/app-constants":154,"../constants/app-status":155,"../utils/fetch":157,"../utils/geolocation":158,"./doctors-list":150,"./status-message":153,"react":148}],153:[function(require,module,exports){
var React     = require('react');
var AppStatus = require('../constants/app-status');
...
var StatusMessage = React.createClass({displayName: 'StatusMessage',
  render: function() {
    ...
    return (
      React.createElement("h2", {className: messageClass}, messageText)
    );
  }
});

module.exports = StatusMessage;
},{"../constants/app-status":155,"react":148}],154:[function(require,module,exports){
module.exports = {
  API_URL: 'https://api.import.io/store/data/3cf27c3b-c9e2-45c8-8a97-c4fc559ed74f/_query?_apikey=Xk6Emf7P1fSYy8lvBrvM0ygZdrQZytV5AAR4ykx5R%2FlwmgvPBYTH7XRwObZESjTduH6C0fsqr9N5y2LC9btu6g%3D%3D&_user=c5b82e89-e0b8-41f9-bdd5-f13f5925b0bb&input/webpage/url=',
  NHS_URL: 'http://www.nhs.uk/Service-Search/GP/England/Results/4/',
  EXTRA_NHS_PARAMS: '/4/0?distance=25&ResultsOnPageValue=30',
  GEOLOCATION_TIMEOUT: 5000,
  GEOLOCATION_MAXIMUM_AGE: 0
};
...
React.render(React.createElement(Search, null), document.getElementById('main'));
},{"./components/home":151,"./components/search":152,"react":148}],157:[function(require,module,exports){
...
},{"es6-promise":1}],158:[function(require,module,exports){
var Promise = require('es6-promise').Promise;
